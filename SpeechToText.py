"""Program to which takes voice Input. 
This program uses speech_recognition library.
This library reads the voice commands from the mic. 
and converts voice to Text message.
